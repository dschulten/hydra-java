...
I would like to thank Mike Amundsen, Stu Charlton, Jon Moore, Mike Kelly, Markus Lanthaler, Gregg Kellog and Many Sporny for their inspiration and for valuable comments along the way. Also thanks to Oliver Gierke who has been accepting some of my pull requests to spring-hateoas.
