hydra-java 
==========
image:https://travis-ci.org/dschulten/hydra-java.svg?branch=master["Build Status", link="https://travis-ci.org/dschulten/hydra-java"]
...
Look into https://github.com/dschulten/hydra-java/blob/master/hydra-core/src/main/java/de/escalon/hypermedia/hydra/serialize/JacksonHydraSerializer.java[JacksonHydraSerializerTest] to see how it works :)
