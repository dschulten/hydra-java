...
/**
 * Unwrapping variant of JacksonHydraSerializer, e.g. to support serialization of wrapper objects which hold the actual
 * bean as a member. Created by dschulten on 16.09.2014.
 */
